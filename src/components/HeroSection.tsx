    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Ribbon 2: The High Intersection */}
          <motion.path
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
          ...
          {/* RIGHT: headshot + floating card */}
          <motion.div
            className='relative flex justify-center items-center'
            style={{ y: imageY, scale: imageScale }}
          >
            <div className='relative w-full max-w-[520px]'>
              {/* Headshot with top-down gradient */}
              <motion.div
              ...
              >
                <img
                  src='/assets/me_2.png'
                  alt='Davies Ajayi'
                  className='w-full h-auto rounded-xl brightness-[0.85]'
                  style={{
                    maskImage:
                ...
                {/* Top-down gradient to protect the navbar */}
                <div
                  className='absolute inset-0 pointer-events-none rounded-xl z-20'
                  style={{
                    background:
                      'linear-gradient(to bottom, rgba(11, 12, 16, 0.95) 0%, rgba(11, 12, 16, 0.4) 15%, transparent 40%)',
                  }}
                />
              </motion.div>

              {/* Floating status card (Wrapped in its own parallax motion div) */}
              <motion.div
                className='absolute right-0 top-1/3 translate-x-1/2 z-40'
                style={{ y: cardY }}
              >
                <motion.div
                  ...
                  className='glass px-5 py-3 rounded-2xl border border-white/10'
                  style={{ backdropFilter: 'blur(14px)', minWidth: 160 }}
                  role='status'
                  aria-live='polite'
                >
                  <div className='flex items-center gap-3'>
                    <motion.span
                      className='block w-3 h-3 rounded-full bg-[#C5F82A]'
                      animate={
                        shouldReduceMotion
                          ? { scale: 1, opacity: 1 }
                    ...
                    />
                    <div>
                      <div className='text-[#C5F82A] text-xs uppercase tracking-wide'>
                        Status
                      </div>
      ...
      >
        <motion.span
          className='text-[#E0E0E0] text-xs tracking-widest uppercase'
        ...
        <motion.div
          className='w-[1px] h-16 bg-[#C5F82A]'
          style={{ originY: 0 }}
          animate={
            shouldReduceMotion
              ? {}
              : {
                  scaleY: [1, 1.6, 1],
                  boxShadow: [
                    '0 0 0px rgba(197,248,42,0.0)',
                    '0 0 10px rgba(197,248,42,0.18)',
                    '0 0 0px rgba(197,248,42,0.0)',
                  ],
                }
          }
