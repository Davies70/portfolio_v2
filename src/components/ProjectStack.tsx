  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className='glass p-4 sm:px-6 sm:py-4 border-b border-white/10 flex flex-col gap-3 sm:gap-4 relative z-30'>
          {/* flex-wrap ensures extreme small screens wrap gracefully */}
        ...
        <div className='flex flex-col'>
          ...
          <div className='p-5 sm:p-6 space-y-3 sm:space-y-4 relative z-20'>
            <h3
              className='font-clash text-white tracking-tight break-words'
              style={{
                fontSize: 'clamp(1.25rem, 7vw, 1.75rem)',
            ...
            {/* Responsive Buttons - split 50/50 on tiny screens, hug content on larger screens */}
            <div className='flex flex-wrap gap-3 sm:gap-4 pt-3 sm:pt-4'>
              {project.link && (
                <a
                  ...
                  className='glass flex-1 sm:flex-none justify-center px-4 py-2.5 sm:px-6 sm:py-3 rounded-full text-xs sm:text-sm text-center hover:bg-white hover:text-[#0B0C10] transition-all'
                  style={{
                    color: project.color,
                    border: `1px solid ${project.color}40`,
                  }}
              ...
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                className='glass flex-1 sm:flex-none justify-center px-4 py-2.5 sm:px-6 sm:py-3 rounded-full text-white text-xs sm:text-sm text-center hover:bg-white hover:text-[#0B0C10] transition-all'
...
const ProjectCardDesktop: React.FC<ProjectCardProps> = ({ project, index }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Glowing 1px border that tracks hover */}
        <motion.div
          className='absolute inset-0 rounded-[30px] pointer-events-none z-20'
          style={{
            border: `1px solid ${project.color}40`,
        ...
        <div className='grid md:grid-cols-2 gap-0 items-center'>
          ...
          {/* Image and Architecture Container */}
          <div className='relative w-full aspect-[4/3] md:h-full overflow-hidden bg-[#0B0C10]'>
            {/* The Image ALWAYS stays in the DOM to preserve container height */}
            <motion.div
              animate={{
                scale: isArchitectureView ? 1.1 : 1,
                opacity: isArchitectureView ? 0.15 : 1,
            ...
            {/* The Architecture view simply overlays on top when toggled */}
            <AnimatePresence>
              {isArchitectureView && (
                <SystemArchitecture
                  key='arch-view'
        ...
        {/* Depth indicator - cards behind look stacked */}
